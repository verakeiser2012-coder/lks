...
**Дополнение:** со второй попытки приложение узнало Bill Cipher как DJ Levka. «Angel Eyes» — одиночное
шумовое срабатывание на разреженном участке (как и случайные попадания API на Ruins/2am). Тревогу снимаем:
со стримингов не снимать. Единственный хвост — спросить Льва, что за запись `2-Audio 0001`, для порядка.
