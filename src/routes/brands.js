...
function getOffers() {
  ...
  return [
    {
      key: 'jingle-podcast',
      title: 'Джингл и подкаст — пакетом',
      description:
        'Оригинальный трек под ваш бренд и выпуск подкаста, где он звучит. По отдельности это разовая услуга, вместе — история: джингл узнают, потому что его слышали в разговоре, а выпуск запоминают, потому что у него своя музыка. Джинглы уже написаны для «Груши», «Флёр» и «Франта», первый выпуск подкаста — с мастерской благовоний «Груша». Берётся только в составе пакета «Кампания» или «Амбассадорство».',
  ...
  return [
    ...
    },
    {
      ...
      includes: [
        ...
        'Джингл бренда и выпуск подкаста, где он звучит — только этой связкой',
