...
// интерьерные флаги 150 × 100 см, сублимация, люверсы по углам). Показываются
...
const flags = [
  ...
  },
  {
    ...
    description:
      'Обложка альбома Soundstates на всю плоскость флага, полтора метра на метр. Не постер под ' +
      'стеклом, а ткань: не бликует, не бьётся и переезжает свёрнутой в конверте.\n\n' +
      'Альбом можно послушать целиком на странице релиза.\n\n' + FLAG_TAIL,
  },
  {
    // 14.09.2026: «Музыка без ИИ» снят, вместо него английская пара одной строкой
    slug: 'flag-slow-in-a-fast-world',
    image: '/uploads/product-flag-slow-in-a-fast-world.jpg',
    name: 'Флаг Slow in a fast world',
    collection_id: slowDrop,
    release_id: null,
    description:
