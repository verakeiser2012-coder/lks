// Убирает пустые разделы каталога: «Новинки», «Хиты продаж», «Аксессуары».
//
...
// «Аксессуары» добавлены 09.09 вторым решением владельца: раздел тоже пустой.
const SLUGS = ['novinki', 'hity-prodazh', 'aksessuary'];
